...
function tieneTresDigitos(numero){
  ...
  var numero; 
   ...
   // var toString = numero.toString(); De esta manera se convierte numero a String y se guarda en la variable toString
    //if ( toString.length === 3){      En el condicional preguntamos si esa cadena es igual a 3
    //    return true;                          
    //} 
    //    return false;
